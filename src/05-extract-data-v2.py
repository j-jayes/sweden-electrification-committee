...
def get_table_data(filename):
    ...
    try:
        # Download the image
        image_url = f"https://github.com/j-jayes/sandbox/blob/main/images_electrification/{filename}?raw=true"
...
list_of_files_to_process = [
    "Älvsborg_1.png",
    "Älvsborg_2.png",
    #  "Älvsborg_3.png", "Älvsborg_4.png", "Älvsborg_5.png", "Älvsborg_6.png", "Älvsborg_7.png", "Älvsborg_8.png", 
